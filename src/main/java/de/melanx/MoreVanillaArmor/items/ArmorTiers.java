...
public enum ArmorTiers implements ArmorMaterial {
    ...
    COPPER(Config.materials.get(Config.DefaultMaterial.COPPER), SoundEvents.ARMOR_EQUIP_IRON, Bonuses.LIGHTNING_MAGNET, () -> Ingredient.of(Items.COPPER_INGOT)),
    ...
    FIERY(Config.materials.get(Config.DefaultMaterial.FIERY), SoundEvents.BLAZE_SHOOT, Bonuses.FIRE_IMMUNITY, () -> Ingredient.of(Items.MAGMA_BLOCK)),
    ...
    OBSIDIAN(Config.materials.get(Config.DefaultMaterial.OBSIDIAN), SoundEvents.ENDER_EYE_DEATH, Bonuses.HEAVY, () -> Ingredient.of(Tags.Items.OBSIDIAN)),
    ...
    REDSTONE(Config.materials.get(Config.DefaultMaterial.REDSTONE), SoundEvents.ARMOR_EQUIP_GOLD, Bonuses.POWER_SOURCE, () -> Ingredient.of(Tags.Items.DUSTS_REDSTONE), () -> Ingredient.of(Tags.Items.STORAGE_BLOCKS_REDSTONE)),
    SLIME(Config.materials.get(Config.DefaultMaterial.SLIME), SoundEvents.SLIME_BLOCK_STEP, Bonuses.DAMAGE_REDUCTION, () -> Ingredient.of(Tags.Items.SLIMEBALLS), () -> Ingredient.of(Items.SLIME_BLOCK)),
    ...
    ArmorTiers(Config.Material material, SoundEvent sound, Bonus bonus, Supplier<Ingredient> repairMaterial, Supplier<Ingredient> ingredient) {
    ...
    ArmorTiers(Config.Material material, SoundEvent sound, Bonus bonus, Supplier<Ingredient> repairMaterial) {
        this.name = material.getName();
        this.durabilityFactor = material.getDurabilityFactor();
        this.damageReductionAmountArray = material.getDamageReduction();
        this.enchantmentValue = material.getEnchantmentValue();
